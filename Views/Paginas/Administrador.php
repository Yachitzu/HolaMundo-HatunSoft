...
<body class="g-sidenav-show  bg-gray-200">
  <aside
    ...
    id="sidenav-main" style="background: rgb(158, 7, 7);">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3"
                ...
                <h6 class="text-white text-capitalize ps-3">Tabla Estudiantes</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nombre 1</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nombre 2</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Apellido 1</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Apellido 2</th>
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><a
                  href="Estudiantes.php">X</a></button>
            </div>
